...
function SetCitiesBox(props) {
	const data = useFetch(
		reducedArray[props.index],
		setCoords(reducedArray[props.index]),
		true
	);
	...
	// 	// 	true
	// 	// );
	// 	const city = reducedArray[index];
	// 	const coords = setCoords(reducedArray[index]);
	// 	const isSetCities = true;
	...
	// const a = reducedArray.map((elem, index) => {
	// 	SetData(index);
	// 	return elem;
	// });
	// console.log(a);
